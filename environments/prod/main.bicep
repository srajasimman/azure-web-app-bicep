...
module storageAccount '../../modules/frontend/storage-account.bicep' = {
  ...
  params: {
    ...
    location: location
    environmentName: environmentName
    skuName: 'Standard_GRS' // Higher redundancy for production
  }
}
...
module frontDoor '../../modules/frontend/front-door.bicep' = {
  ...
  params: {
    ...
    enableWAF: true // Enable WAF for production
  }
}
...
module appService '../../modules/backend/app-service.bicep' = {
  ...
  params: {
    ...
    location: location
    environmentName: environmentName
    skuName: 'P1V2' // Higher SKU for production
    skuCapacity: 2  // Multiple instances for redundancy
  }
}
...
module mySql '../../modules/backend/mysql.bicep' = {
  ...
  params: {
    ...
    skuName: 'GP_Gen5_4' // Higher tier for production
    storageSizeGB: 100   // More storage for production
